<template>
  <div>
    <v-card
      ...
      >
      <v-card-actions
        ><v-btn @click="editDialog = true" color='primary'
    ...
    <v-dialog v-model="editDialog" width="800px"
      ><v-card
        ><v-col cols='12'> <v-text-field v-model="contactLeider.gsm" v-mask="mask" :rules='regelGsm' label='GSM' outlined width="200px"></v-text-field></v-col>
 <!--       <v-col> <v-text-field
